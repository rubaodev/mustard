...
//!
//! 1. Parses `## Funções tocadas` via [`crate::spec::touched_functions::parse`]
...
//!    [`crate::spec::touched_functions::Qualifier`]):
...
//! 3. Resolves a language id via [`crate::ast::GrammarLoader::language_id_for_path`]
//!    (W1.5). When the loader returns `Some`, the AST path is attempted:
//!    [`crate::ast::TreeSitterParser::for_language`] +
//!    [`crate::ast::extract_function_signatures`] locate the function and
...
use crate::ast::{AstError, GrammarLoader, TreeSitterParser, extract_function_signatures};
use crate::spec::touched_functions::{self, Qualifier, TouchedFunction, TouchedFunctions};
...
fn try_capture_via_ast(
    ...
    lang_id: &str,
    final_name: &str,
) -> Result<Option<(String, TextSpan, Option<crate::ast::FunctionSig>)>, AstError> {
...
/// [`crate::ast::extract_function_signatures`] fallback). Then capture from

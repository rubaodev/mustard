...
//!   The detection of *what* to capture lives in [`crate::spec::touched_functions`]
//!   (W0). The grammar resolution lives in [`crate::ast`] (W1.5).
...
//!   [`crate::ast::GrammarLoader`] by reference; no language id is enumerated
...
//!   [`crate::ast::extract_function_signatures`] to locate function spans
...
/// Mirrors the shape of [`crate::ast::FunctionSig::span`] so callers that
...
///
/// Distinct from [`crate::ast::DetectionMode`] even though the variants line
...
pub enum CaptureMode {
    /// Grammar was resolved via [`crate::ast::GrammarLoader`]; the body was
...
pub struct FunctionCapture {
    ...
    /// when it is `None`.
    pub signature: Option<crate::ast::FunctionSig>,

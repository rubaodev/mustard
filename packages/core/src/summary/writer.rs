...
///
/// # Errors
/// Returns [`crate::error::Error::Parse`] if serialisation fails (should not
/// happen with valid structs), or [`crate::error::Error::Io`] on filesystem
/// failures.
...
mod tests {
    use super::*;
    use crate::summary::{AcResult, SpecSummaryDoc, WaveSummary};

...
const STAGES: StageDef[] = [
  { bucket: "planejando", labelKey: "overview.specStage.planning", labelFallback: "Planejando", icon: Layers },
  { bucket: "executando", labelKey: "overview.specStage.executing", labelFallback: "Executando", icon: Play },
  { bucket: "finalizadas", labelKey: "overview.specStage.finished", labelFallback: "Finalizadas", icon: CheckCircle2 },
];
...
function StageCard({
  ...
  return (
    <button
      ...
      title={label}
      className={cn(
        "flex flex-col gap-1 px-3 py-2.5 rounded-lg border border-border bg-card/40 text-left",

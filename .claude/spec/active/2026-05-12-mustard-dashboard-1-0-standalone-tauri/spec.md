# Mustard Dashboard 1.0 — Standalone Tauri Desktop Product
...
- **Unlocks**: produto comercializável separado
...
## What this REMOVES from Mustard core

Vai pra spec adjacente de update do Phase 3 (revisar):

- ✗ `templates/scripts/dashboard.js` (60KB) — DEPRECATED, mantido por 1 release pra compat
...
- ✗ `/mustard:dashboard` slash command — substituído por instrução pra instalar Mustard Dashboard

**Total que sai do Mustard core: ~80KB de código mantido por projeto.**
...
- [ ] Decidir repo: monorepo (`packages/dashboard-app/`) OU dedicado (`mustard-dashboard`)
...
- [ ] Mustard core: deprecate dashboard.js (mover pra Phase 3 spec)
